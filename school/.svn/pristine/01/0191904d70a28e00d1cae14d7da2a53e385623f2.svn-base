...
@Service
public class ClazzAlbumCreateProcess implements ClazzAlbumProcess {
	private static final Logger logger = Logger
			.getLogger(ClazzAlbumCreateProcess.class);
	@Resource
	...
	public boolean doProcess(ClazzAlbumProcessContext context) {
		try {
			...
			AlbumInfoResult result = albumService.albumCreate(info);
