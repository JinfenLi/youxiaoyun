...
public class ClazzAlbumServiceImpl implements ClazzAlbumService {
	...
	private List<ClazzAlbumProcess> clazzAlbumDeletesProcesses;
	/**
	 * 获取相册
	 */
	@Override
	...
	public AlbumInfoResult deleteAlbums(String albumIds) {
		ClazzAlbumProcessContext context = new ClazzAlbumProcessContext();
		AlbumInfo info = new AlbumInfo();
		AlbumInfoResult result = new AlbumInfoResult();
		info.setId(albumIds);
		context.setResult(result);
		context.setInfo(info);
		for (ClazzAlbumProcess process : clazzAlbumDeletesProcesses) {
			if (!process.doProcess(context)) {
				break;
			}
		}
	...
	public List<ClazzAlbumProcess> getClazzAlbumDeletesProcesses() {
		return clazzAlbumDeletesProcesses;
	}

	public void setClazzAlbumDeletesProcesses(List<ClazzAlbumProcess> clazzAlbumDeletesProcesses) {
		this.clazzAlbumDeletesProcesses = clazzAlbumDeletesProcesses;
	}
