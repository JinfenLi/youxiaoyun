...
public class LeaveController {
	 ...
	 * @return
	 */
	@RequestMapping("getCountByTeacherId")
	@ResponseBody
	public String getCountByTeacherId(HttpSession session, String userId,String semesterId) {
		Map<String, Object> resultMap = new HashMap<String, Object>();
		UserInfo userInfo = (UserInfo) session.getAttribute("currentUser");
		if(userInfo.getUser_type() != UserType.Teacher) {
			resultMap.put("success", false);
		}
		else {
			LeaveInfo leaveInfo = new LeaveInfo();
			leaveInfo.setTeacherId(userId);
			LeaveInfoResult result = leaveService.getCountByTeacherId(leaveInfo, semesterId);
			resultMap.put("count", result.getCode());
			resultMap.put("success", true);
		}
