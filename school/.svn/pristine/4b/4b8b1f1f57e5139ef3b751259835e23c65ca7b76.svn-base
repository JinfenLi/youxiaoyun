...
public class ExamInfo {
	...
	private ExamTemplet examTemplet;
	...
	public static Exam changeToPo(ExamInfo info) {
		...
		exam.setTempletId(info.getTempletId());
	...
	public static ExamInfo changeToVo(Exam exam) {
		...
		info.setTempletId(exam.getTempletId());
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
	...
	public ExamTemplet getExamTemplet() {
		return examTemplet;
	}

	public void setExamTemplet(ExamTemplet examTemplet) {
		this.examTemplet = examTemplet;
	}
}
