...
public class ContactsInfoResult {
	...
	public String toString() {
		return "ContactsInfoResult [success=" + success + ", code=" + code + ", studentResult=" + studentResult
				+ ", teacherResult=" + teacherResult + ", parentContacts=" + parentContacts + ", teacherContacts="
				+ teacherContacts + "]";
	}
