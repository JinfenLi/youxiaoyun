...
public class SubjectController {
	...
	public String createSubject(Subject subject, HttpSession sesssion) {
		...
		List<Subject> list = subjectService.isExist(subject.gettScSchoolId(), subject.getName());
		
		ValidationResult validationResult = ValidationUtil.validateEntity(subject);
	...
	public String updateSubject(SubjectVo subjectVo) {
		...
		ValidationResult res = ValidationUtil.validateEntity(subjectVo);
		if(res.isHasErrors()) {
			resultMap.put("success", false);
