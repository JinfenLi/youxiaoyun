...
public class LeaveServiceImpl implements LeaveService {
	...
	private List<LeaveProcess> getCountByTeacherIdProcesses;
	...
	public LeaveInfoResult getCountByTeacherId(LeaveInfo leaveInfo, String semesterId) {
		...
		context.setInfo(leaveInfo);
		context.setResult(result);
		context.setSemesterId(semesterId);
		for (LeaveProcess process : getCountByTeacherIdProcesses) {
			if (!process.doProcess(context))
				break;
		}
		return context.getResult();
	...
	public List<LeaveProcess> getGetCountByTeacherIdProcesses() {
		return getCountByTeacherIdProcesses;
	}

	public void setGetCountByTeacherIdProcesses(List<LeaveProcess> getCountByTeacherIdProcesses) {
		this.getCountByTeacherIdProcesses = getCountByTeacherIdProcesses;
	}
