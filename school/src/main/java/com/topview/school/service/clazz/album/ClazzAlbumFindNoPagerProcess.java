...
@Service
public class ClazzAlbumFindNoPagerProcess implements ClazzAlbumProcess {
	private static final Logger logger = Logger
			.getLogger(ClazzAlbumFindNoPagerProcess.class);
	@Resource
	...
	public boolean doProcess(ClazzAlbumProcessContext context) {
		try {
			...
			AlbumInfoResult result = albumService.albumFindNoPager(info);
