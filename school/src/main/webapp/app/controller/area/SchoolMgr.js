...
Ext.define("School.controller.area.SchoolMgr", {
	...
	editSchool: function(button) {
		...
		var semesterName = editWindow.down('form').queryById("semesterName"),
		    startTime = editWindow.down('form').queryById("startTime"),
		    endTime = editWindow.down('form').queryById("endTime"),
		    week =  editWindow.down('form').queryById("week");
		    semesterName.hide();
		    semesterName.allowBlank = true;
		    startTime.hide();
		    startTime.allowBlank = true;
		    endTime.hide();
		    endTime.allowBlank = true;
		    week.hide();
		    week.allowBlank = true;
