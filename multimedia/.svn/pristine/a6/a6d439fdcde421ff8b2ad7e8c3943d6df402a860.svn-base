...
public class AlbumServiceImpl implements AlbumService {
	...
	private List<AlbumProcess> albumFindByIdProcesses;
	...
	public AlbumInfoResult getAlubmById(AlbumInfo info) {
		return doProcess(info,albumFindByIdProcesses);
	}
	...
	public List<AlbumProcess> getAlbumFindByIdProcesses() {
		return albumFindByIdProcesses;
	}

	public void setAlbumFindByIdProcesses(List<AlbumProcess> albumFindByIdProcesses) {
		this.albumFindByIdProcesses = albumFindByIdProcesses;
	}
