...
@Service
public class ClazzVideoFindNoPagerProcess implements ClazzVideoProcess{
	private static final Logger logger = Logger
			.getLogger(ClazzVideoFindNoPagerProcess.class);
	@Autowired
	private VideoService VideoService;
	@Override
	public boolean doProcess(ClazzVideoProcessContext context) {
		try{
		VideoInfoResult result = VideoService.videoFindNoPager(context.getInfo());
