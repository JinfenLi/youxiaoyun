...
/**
 * 查找全部图片
 * 项目名称:com.topview.multimedia.service.album.photo<br>
 * 
 * @author houwenjun<br>
 * 创建时间:Apr 11, 2015<br>
 */
@Service
public class PhotoFindNoPagerProcess implements PhotoProcess {
	private static final Logger logger = Logger
			.getLogger(PhotoFindNoPagerProcess.class);
	@Autowired
	...
	public boolean doProcess(PhotoProcessContext context) {
		...
		try {
			...
			List<MultimediaPhoto> l = multimediaPhotoMapper.findByMulti0(param);
